#!/usr/bin/env python3
"""Validate the ExactSeq skill bundle without third-party dependencies."""
...
def main() -> int:
    skill_dir = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("skill/exactseq")
    ...
    print("[OK] ExactSeq skill bundle is valid")
    return 0
